...
export const Route = createFileRoute("/carrinho")({
  head: () => ({
    meta: [
      { title: "Carrinho de Compras | Dubai Enxovais" },
      {
        name: "description",
        content:
          "Revise os itens do seu carrinho e finalize sua compra de cama, mesa, banho e decoração na Dubai Enxovais.",
      },
      { property: "og:title", content: "Carrinho de Compras | Dubai Enxovais" },
      {
        property: "og:description",
        content: "Revise seus produtos e siga para o checkout da Dubai Enxovais.",
      },
